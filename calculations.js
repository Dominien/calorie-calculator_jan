...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Function to hide warnings on valid input
    ...
    hideWarningOnInput(weightInput, weightWarning);

    // Function to handle radio button changes (Weight Loss Option)
    ...
    abnehmzielRadios.forEach(radio => {
        radio.addEventListener('change', () => {
            abnehmzielWarning.style.display = 'none'; // Hide warning when an option is selected
        });
    });
